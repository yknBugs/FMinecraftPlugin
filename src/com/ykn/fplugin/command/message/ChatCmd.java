...
public class ChatCmd extends MessageCommand {

    public Player player;

    public ChatCmd(CommandSender sender, Command command, String label, String[] args, int index) {
    ...
    public boolean onLegalExecute(boolean isConsole) {
        ...
        if (player == null) {
            if (hasPrefix) {
                BroadcastInfo.broadcastMessage(msg);
            } else {
                BroadcastInfo.broadcastNoPrefixMessage(msg);
            }
        } else {
            if (hasPrefix) {
                BroadcastInfo.sendMessage(player, msg);
            } else {
                BroadcastInfo.sendNoPrefixMessage(player, msg);
            }
        }
